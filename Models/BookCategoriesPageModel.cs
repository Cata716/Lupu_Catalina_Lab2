...
namespace Lupu_Catalina_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Lupu_Catalina_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Lupu_Catalina_Lab2Context context,
